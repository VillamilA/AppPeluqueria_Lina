...
class _ClientFormPageState extends State<ClientFormPage> with SingleTickerProviderStateMixin {
    ...
    try {
      ...
      if (mounted) {
        AppDialogHelper.showSuccess(
          context,
          title: 'Cliente ${widget.isEdit ? 'actualizado' : 'creado'}',
          message: '${widget.isEdit ? 'Cambios guardados' : 'Cliente registrado'} exitosamente',
          onAccept: () {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          widget.isEdit ? 'Editar Cliente' : 'Nuevo Cliente',
